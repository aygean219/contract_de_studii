...
class GUI :public QWidget {
	...
	QPushButton* addContract = new QPushButton("Adauga in contract");
	QPushButton* randomContract = new QPushButton("Generare contract");
	QPushButton* deleteContract = new QPushButton("Golire contract");
...
public:
	...
	void Layout() {
		...
		QLabel* denLabelFind = new QLabel("Denumire");
		QLabel* cadruDidacticLabelFind = new QLabel("Cadru Didactic");
		...
		QLabel* cadruDidacticLabel = new QLabel("Cadru Didactiv");
		QLabel* tipLabel = new QLabel("Tip");
		QLabel* nrOreLabel = new QLabel("Numar Ore");
		...
		QLabel* cadruDidacticLabelAdd = new QLabel("Cadru Didactic");
		QLabel* tipLabelAdd = new QLabel("Tip");
		QLabel* nrOreLabelAdd = new QLabel("Numar Ore");
		...
		QLabel* cadruDidacticLabelUpd = new QLabel("Cadru Didactic");
		QLabel* tipLabelUpd = new QLabel("Tip");
		QLabel* nrOreLabelUpd = new QLabel("Numar Ore");
	...
	QPushButton* exportContract = new QPushButton("Export contract");*/
		...
		QLabel* denLabelContract = new QLabel("Denumire");
		QLabel* cadruDidacticLabelContract = new QLabel("Cadru Didactic");
		...
		QLabel* randomLabelContract = new QLabel("Numar discipline");
		contractLayout->addRow(randomLabelContract, nrContractBox);
		contractLayout->addWidget(randomContract);

		QLabel* fileLabelContract = new QLabel("Nume fisier");
	...
	void Connections()
	{
		...
		QObject::connect(randomContract, &QPushButton::clicked, [=]() {
			...
			else
			{
				...
				{
					QMessageBox::warning(nullptr, "WARNING", QString::fromStdString("Discipline insuficiente"));
				}
				else
				{
